...
# ===== Beállítások =====
DB_PATH = "project.db"
ADAGOK_PATH = "data/Adagok.csv"

# Ékezetmentes elérési út – nevezd át a fájlt Hutopanelek.csv-re!
PANELEK_PATH = "data/Hutopanelek.csv"

DEBUG = True  # állítsd False-ra, ha nem kérsz részletes kiírást
